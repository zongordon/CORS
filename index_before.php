...
<div id="content">    
  ...
  <div class="story">
    <h2>Tid och plats</h2>
    <p>L&ouml;rdagen <?php echo $row_rsCurrentComp['comp_start_date']?> kl. 10.00 i Munktellarenan i Eskilstuna, Verkstadsgatan 5. <!-- L&auml;nk till planeringen per tatami (matta): <a href="pdf/Tidsplanering  3 tatami.pdf" title="Planering per tatami" target="_blank">h&auml;r</a><br /> -->
